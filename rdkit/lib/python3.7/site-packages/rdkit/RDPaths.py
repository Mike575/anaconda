...
RDCodeDir=os.path.join(r'/home/firefox/anaconda3/envs/rdkit/lib/python3.7/site-packages','rdkit')
# not really hard-coded alternative RDCodeDir=os.path.dirname(__file__)
_share = os.path.join(r'/home/firefox/anaconda3/envs/rdkit', r'share/RDKit')
